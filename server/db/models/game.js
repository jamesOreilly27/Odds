...
const Game = db.define('game', {
  ...
  PointSpreadHomeLine: { type: Sequelize.STRING, allowNull: false },
  MoneyLineAway: { type: Sequelize.STRING, allowNull: false },
  PointSpreadAway: { type: Sequelize.STRING, allowNull: false},
  PointSpreadAwayLine: { type: Sequelize.STRING, allowNull: false },
  TotalNumber: { type: Sequelize.STRING, allowNull: false },
  OverLine: { type: Sequelize.STRING, allowNull: false },
  UnderLine: { type: Sequelize.STRING, allowNull: false },
